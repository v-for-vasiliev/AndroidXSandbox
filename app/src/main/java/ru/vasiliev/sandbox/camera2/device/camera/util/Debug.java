...
import static ru.vasiliev.sandbox.camera2.device.camera.Camera2StateMachine.STATE_CAPTURING;
import static ru.vasiliev.sandbox.camera2.device.camera.Camera2StateMachine.STATE_LOCKED;
import static ru.vasiliev.sandbox.camera2.device.camera.Camera2StateMachine.STATE_LOCKING;
import static ru.vasiliev.sandbox.camera2.device.camera.Camera2StateMachine.STATE_PRECAPTURE;
