    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mLastLocationButton!!.setOnClickListener {
            if (isLocationRequestingRunning) {
                ...
                mSubscriptions.add(lastLocation.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(
                        { location ->
        ...
        mLocationButton!!.setOnClickListener {
            if (isLocationRequestingRunning) {
                ...
                mSubscriptions.add(location.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(
                        { location ->
        ...
        mLocationsHistoryButton!!.setOnClickListener {
            if (isLocationRequestingRunning) {
                ...
                mSubscriptions.add(locationHistory.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).take(
